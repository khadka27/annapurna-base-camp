...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#395371] text-white">
      ...
      <main className="flex-grow space-y-24 pb-16">
        {/* Hero Section */}
        <DynamicHero />
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <ScrollReveal variant="fade-up" delayMs={100}>
              <div className="bg-white/5 p-6 rounded-3xl border border-white/15 hover:border-[#4F9CF9]/40 transition-all space-y-3 h-full">
            ...
            <ScrollReveal variant="fade-up" delayMs={200}>
              <div className="bg-white/5 p-6 rounded-3xl border border-white/15 hover:border-[#F97316]/40 transition-all space-y-3 h-full">
            ...
            {/* 3 */}
            <ScrollReveal variant="fade-up" delayMs={300}>
              <div className="bg-white/5 p-6 rounded-3xl border border-white/15 hover:border-[#16A34A]/40 transition-all space-y-3 h-full">
            ...
            {/* 4 */}
            <ScrollReveal variant="fade-up" delayMs={100}>
              <div className="bg-white/5 p-6 rounded-3xl border border-white/15 hover:border-white/30 transition-all space-y-3 h-full">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {featuredRooms.map((room, idx) => (
              <ScrollReveal key={room.id} variant={idx === 0 ? "fade-right" : "fade-left"}>
                <div className="bg-white/5 rounded-3xl overflow-hidden border border-white/15 flex flex-col justify-between h-full">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {[
              ...
              <ScrollReveal key={idx} variant="fade-up" delayMs={(idx % 4) * 100}>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <ScrollReveal variant="fade-up" delayMs={100}>
              <div className="p-6 rounded-3xl bg-white/5 border border-white/15 space-y-4 h-full">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              <ScrollReveal key={idx} variant="zoom-in" delayMs={(idx % 4) * 80}>
